...
This repository contains [ReDoc](https://github.com/Redocly/redoc) resources (complying OpenAPI specification) for the RESTful API documentation of **Club Event Calendar** project.  
The project originated from Busan Developers Club (BGM): [BusanDevelopers/BGM-Event-Calendar-API-Documentation](https://github.com/BusanDevelopers/BGM-Event-Calendar-API-Documentation)
